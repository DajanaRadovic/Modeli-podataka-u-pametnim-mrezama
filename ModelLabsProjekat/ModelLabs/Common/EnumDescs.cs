...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUEONEMULT, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUEONEUNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUETWOMULT, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCHEDULE_VALUETWOUNIT, typeof(UnitSymbol));
		}
